...
export const STORY_SECTIONS: StorySectionDef[] = [
  // El co-writer es una feature de pago: solo se muestra si está habilitado.
  ...(ENABLE_COWRITER
    ? [{ key: 'co-writer' as const, label: 'Co-writer', icon: 'bi-stars', headingId: 'story-section-co-writer' }]
    : []),
