...
> **Status:** `0.10.3` — chat-assisted global outline + automatic structure generation + orphan scene panel. Local-first fiction co-writer where **the conversation is the product**: an agent you converse with that knows the manuscript, bible, outline and compass, and that **applies** changes to the content when you accept them.
